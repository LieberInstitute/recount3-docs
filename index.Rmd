...
* `monorail`: TODO
* `megadepth`: TODO
* `recount3`: R package [source](https://github.com/LieberInstitute/recount3), Bioconductor [landing page](https://bioconductor.org/packages/recount3), `pkdown` documentation [website](https://LieberInstitute.github.io/recount3)
* [`recount3-docs`]((https://github.com/LieberInstitute/recount3-docs): the source code for this documentation website.
