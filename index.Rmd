...
* `monorail`: TODO
* `megadepth`: software [source](https://github.com/ChristopherWilks/megadepth), R package [source](https://github.com/LieberInstitute/megadepth), Bioconductor [landing page](https://bioconductor.org/packages/megadepth), `pkgdown` documentation [website](https://LieberInstitute.github.io/megadepth)
