...
As noted in the [Bioconductor chapter](#bioconductor), detailed vignette documents showing further details of our R/Bioconductor packages are available from the Bioconductor landing pages, such as the one called [`recount3` quick start guide](http://bioconductor.org/packages/release/bioc/vignettes/recount3/inst/doc/recount3-quickstart.html).
